...
> This file mirrors `CLAUDE.md` (the canonical skill index) for Gemini CLI. Keep `CLAUDE.md`, `AGENTS.md`, and `GEMINI.md` in sync when adding, renaming, or removing skills.
